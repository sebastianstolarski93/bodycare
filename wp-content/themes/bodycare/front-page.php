	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-right">
				<h2>Przyjemność przekształca</h2>
				<h2>się w energię</h2>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row treatments">
						<a href="http://bodycare-bc.pl/zabiegi/zabiegi-na-twarz/" class="col-lg-4 col-sm-4 col-xs-6" target="_self">
							<img src="/wp-content/uploads/2017/11/sg_1-1.png" alt="">
							<span class="text">Zabiegi na twarz</span>
						</a>
						<a href="http://bodycare-bc.pl/zabiegi/pielegnacja-i-upiekszanie-okolic-oka/" class="col-lg-4 col-sm-4 col-xs-6" target="_self">
							<img src="/wp-content/uploads/2017/11/sg_2.png" alt="">
							<span class="text">Pielęgnacja i upiększanie okolic oka</span>
						</a>
						<a href="http://bodycare-bc.pl/zabiegi/zabiegi-na-cialo/" class="col-lg-4 col-sm-4 col-xs-6" target="_self">
							<img src="/wp-content/uploads/2017/11/sg_3.png" alt="">
							<span class="text">Zabiegi na ciało</span>
						</a>
						<a href="http://bodycare-bc.pl/zabiegi/masaze/" class="col-lg-4 col-sm-3 col-xs-6" target="_self">
							<img src="/wp-content/uploads/2017/11/sg_5.png" alt="">
							<span class="text">Masaże</span>
						</a>
						<a href="http://bodycare-bc.pl/zabiegi/depilacja-woskiem/" class="col-lg-4 col-sm-4 col-xs-6" target="_self">
							<img src="/wp-content/uploads/2017/11/sg_7.png" alt="">
							<span class="text">Depilacja woskiem</span>
						</a>
						<a href="http://bodycare-bc.pl/zabiegi/pielegnacja-dloni-i-stop/" class="col-lg-4 col-sm-4 col-xs-6" target="_self">
							<img src="/wp-content/uploads/2017/11/sg_4.png" alt="">
							<span class="text">Pielęgnacja dłoni i stóp</span>
						</a>
					</div>
			</div>
		</div>
